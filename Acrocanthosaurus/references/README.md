...
acro_character_sheet_reference.png — anatomy, proportions, coloration, and character identity

acro_environment_plate_reference.png — environment, lighting, and landscape identity

acro_environment_with_acro_reference.png — integration, scale, and overall visual style
